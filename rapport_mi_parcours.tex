...
\section*{Présentation succincte du sujet}% ne suis pas passé par là
...
et essayer de corriger une faille mal comprise.
    ...
    \paragraph{Objectif de cette première partie d'année} Dans l'optique de trouver des solutions de sécurisation en dernier lieu du projet, la première partie de notre travail a consisté à chercher différents moyens d'exploiter la faible sécurisation des données transmises entre un appareil et une borne Wi-Fi.

	Nous nous sommes donc mis «~dans la peau du hacker~» et avons élaboré un programme permettant de récupérer des données transmises entre un appareil connecté et une borne Wi-Fi publique à l'insu du propriétaire de l'appareil.

	C'est à l'encontre des procédés que nous développons dans la première partie que nous chercherons des moyens de sécurisation dans la suite de notre projet.
...
\section{Le point sur nos résultats}
    ...
    \subsection{Interruption d'une communication TCP établie}% ne suis pas passé par ici
...
\section{Actualisation des objectifs}% ne suis pas passé par ici
...
\section*{Conclusion}% ne suis pas passé par ici
